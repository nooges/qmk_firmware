...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_80_iso_with_macro(
    ...
    KC_F9,   KC_F10,  KC_LCTL, KC_LGUI, KC_LALT, MO(1),   KC_SPC,  KC_SPC,           MO(1),   KC_SPC,  KC_RALT, MO(1),   KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT
  ),
  [1] = LAYOUT_80_iso_with_macro(
    ...
    RGB_SAI, RGB_SAD, RGB_TOG, RGB_MOD, _______, KC_UP,   QK_BOOT, _______, _______, _______, _______, _______, _______, _______, _______,          _______,
    ...
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, EE_CLR,  _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, _______, _______, _______,          _______, _______, _______, _______, _______, _______, _______, _______
  ),
};
