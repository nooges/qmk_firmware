...
#define ESCC MT(MOD_LCTL, KC_ESC)
#define GRVF LT(3, KC_GRV)
#define ENTS MT(MOD_LSFT, KC_ENT)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_ortho_5x12(
        ...
        GRVF,    KC_LCTL, KC_LALT, KC_LGUI, MO(1),   KC_SPC,  KC_BSPC, MO(2),   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
    ),
    [1] = LAYOUT_ortho_5x12(
    ...
    [2] = LAYOUT_ortho_5x12(
        ...
        KC_DEL,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_UNDS, KC_EQL,  KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS,
        _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_MINS, KC_PLUS, KC_NUHS, KC_NUBS, KC_PGUP, KC_PGDN, _______,
